...
start "" "%RHINO_PATH%" "%FILEPATH%" /runscript="_-RunPythonScript %USER_PATH%\AppData\Roaming\McNeel\Rhinoceros\7.0\scripts\RhinoScripts\scripts\all_cad_cam_nyc_close.py"
