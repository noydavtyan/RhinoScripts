...
start "" "%RHINO_PATH%" "%FILEPATH%" /runscript="_-RunPythonScript %USER_PATH%\AppData\Roaming\McNeel\Rhinoceros\7.0\scripts\RhinoScripts\scripts\create_separate_stl_and_separate_videos_in_silver.py"
